...
//AJTH: The BCD for the ten hours portion of the adjusted time
//AJH: The BCD for the hours portion of the adjusted time
//AJTM: The BCD for the ten minutes portion of the adjusted time
//AJM: The BCD for the minutes portion of the adjusted time
//ATH: The BCD for the ten hours portion of the alarm time
//AH: The BCD for the hours portion of the alarm time
//AJCTH: The BCD for the ten hours portion of the adjusted clock time
//AJCH: The BCD for the hours portion of the adjusted clock time
//AJCTM: The BCD for the ten minutes portion of the adjusted clock time
//AJCM: The BCD for the minutes portion of the adjusted clock time
...
X_Bit_Counter #(4,10) Adjust_Alarm_Hour (clk,rst ,IND|INU,IND,AH);
X_Bit_Counter #(4,3) Adjust_Alarm_Ten_Hour (clk,rst ,enable_ten_alarm_hours&(IND|INU),IND,ATH);

//X_Bit_Counters to change the alarm minute
X_Bit_Counter #(4,10) Adjust_Alarm_Minute (clk,rst ,IND|INU,IND,AM);
X_Bit_Counter #(4,6) Adjust_Alarm_Ten_Minute (clk,rst ,enable_ten_alarm_minutes&(IND|INU),IND,ATM);

//X_Bit_Counters to change the clock hour
X_Bit_Counter #(4,10) Adjust_Clock_Hour (clk,rst ,IND|INU,IND,AJH);
X_Bit_Counter #(4,3) Adjust_Clock_Ten_Hour (clk,rst ,enable_ten_clock_hours&(IND|INU),IND,AJTH);

//X_Bit_Counters to change the clock minute
X_Bit_Counter #(4,10) Adjust_Clock_Minute (clk,rst ,IND|INU,IND,AM);
X_Bit_Counter #(4,6) Adjust_Clock_Ten_Minute (clk,rst ,enable_ten_clock_minutes&(IND|INU),IND,ATM);
endmodule