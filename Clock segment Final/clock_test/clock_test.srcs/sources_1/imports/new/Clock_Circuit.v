...
Counter4bit c1(4'b0000, clk, (S== 9) , (TS==10), TS);
//counting and adjusting minutes
mux2_1 m0(AJM, 4'b0000, INC2, s1);
Counter4bit c2(s1, clk, (TS==10), ((Mode == 1 && INC2 ==1) || (CM == 10)), CM);
mux2_1 m1(AJTM, 4'b0000, INC2, s2);
Counter4bit c3(s2, clk, (CM==10),((Mode == 1 && INC2 ==1) || (CTM == 6)), CTM);
//counting and agjusting hours
mux2_1 m2(AJH, 4'b0000, INC2, s3);
Counter4bit c4(s3, clk, (CTM== 6), (((CH == 4 && CTH==2) || (CH==10)) || (Mode == 1 && INC2 ==1)), CH);    
mux2_1 m3(AJTH, 4'b0000, INC2, s4);
Counter4bit c5(s4, clk, (CH==10), (CTH == 2 && CH == 4)|| (Mode == 1 && INC2 ==1), CTH);    
